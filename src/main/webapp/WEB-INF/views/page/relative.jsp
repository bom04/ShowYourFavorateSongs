		...
		<section>
			<div id="content">
				...
				<div
					...
					<h1 style="font-size: 23pt">관련 사이트</h1>
				</div>
				...
				<div class="container">
					...
					<div class="jumbotron"
						...
						<a href="http://www.ikaraoke.kr/isong/recommend_20.asp"
							target="_blank" style="text-decoration: none; color: #fff;">
							<div
								style="width: 100%; display: inline-block; margin: 10px; background: #1C1C1C;">
								<div class="card-body" style="">
									<h4 class="card-title">금영</h4>
									<p class="card-text">반주곡 신청</p>
								</div>

							</div>

						</a> <a href="https://www.tjmedia.co.kr/tjsong/song_songRequest.asp"
							target="_blank" style="text-decoration: none; color: #fff;">
							<div
								style="width: 100%; display: inline-block; margin: 10px; background: #1C1C1C;">
								<div class="card-body" style="">
									<h4 class="card-title">태진</h4>
									<p class="card-text">반주곡 신청</p>
								</div>
