			...
			<div id="content">
				<div class="container-fluid">
					...
					<div
						...
						<div
							style="font-weight: bold; color: #2E2E2E; text-align: center; margin-top: 30px;">
							<a class="a1" style="cursor: pointer" data-url="findPw"><span>비밀번호
									찾기</span></a> <span> | </span> <a class="a1" style="cursor: pointer"
								data-url="join"><span>회원가입</span></a>
						</div>
