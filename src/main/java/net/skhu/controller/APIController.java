...
public class APIController {
	...
	public String user(Model model, @RequestParam("user_idx") int user_idx, @RequestParam("kara_type") int kara_type,
		...
		for (int i = 0; i < user.getUsers3().size(); i++) { // my_user1와 other_user1하고 size()가 다름
			followedNum++;
			System.out.println("상대방을 팔로워한 user_idx: " + user.getUsers3().get(i).getUser_idx()); // 현재 마이페이지의 유저를 팔로우 한
																								// user_idx가
																								// 반환됨==my_user1인지 확인
		}
...
//		System.out.println("nickname:" + nickname + " message:" + message + " password:" + password);
	...
	public String notice(Model model, @RequestParam("pg") int pg) {
		...
		for (int i = 0; i < notices_ex.size(); i++) {
			map.put(notices_ex.get(i).getPost_id(),
					post_likeRepository.findPost_like_num(notices_ex.get(i).getPost_id()));
	...
	public String bestBoard(Model model, @RequestParam("pg") int pg) {
		...
		for (int i = 0; i < bestPosts.size(); i++) {
			likes.put(bestPosts.get(i).getPost_id(),
					post_likeRepository.findPost_like_num(bestPosts.get(i).getPost_id()));
		}
	...
	public String chartBoard(Model model, @RequestParam("kara_type") int kara_type, final HttpSession session,
			HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	public String freeBoard(Model model, @RequestParam("pg") int pg) {
		...
		for (int i = 0; i < freePosts_ex.size(); i++) {
			map.put(freePosts_ex.get(i).getPost_id(),
					post_likeRepository.findPost_like_num(freePosts_ex.get(i).getPost_id()));
			// System.out.println("post_id: "+freePosts_ex.get(i).getPost_id()+" count:
			// "+post_likeRepository.findPost_like_num(freePosts_ex.get(i).getPost_id()));
		}
	...
	public String tipBoard(Model model, @RequestParam("pg") int pg) {
		...
		for (int i = 0; i < tipPosts_ex.size(); i++) {
			map.put(tipPosts_ex.get(i).getPost_id(),
					post_likeRepository.findPost_like_num(tipPosts_ex.get(i).getPost_id()));
			// System.out.println("post_id: "+freePosts_ex.get(i).getPost_id()+" count:
			// "+post_likeRepository.findPost_like_num(freePosts_ex.get(i).getPost_id()));
		}
		model.addAttribute("map_like", map);
	...
	public String recommendBoard(Model model, @RequestParam("pg") int pg) {
		...
		for (int i = 0; i < recomPosts_ex.size(); i++) {
			map.put(recomPosts_ex.get(i).getPost_id(),
					post_likeRepository.findPost_like_num(recomPosts_ex.get(i).getPost_id()));
			// System.out.println("post_id: "+freePosts_ex.get(i).getPost_id()+" count:
			// "+post_likeRepository.findPost_like_num(freePosts_ex.get(i).getPost_id()));
		}
		model.addAttribute("map_like", map);
	...
	public String boastBoard(Model model, @RequestParam("pg") int pg) {
		...
		for (int i = 0; i < boastPosts_ex.size(); i++) {
			map.put(boastPosts_ex.get(i).getPost_id(),
					post_likeRepository.findPost_like_num(boastPosts_ex.get(i).getPost_id()));
			// System.out.println("post_id: "+freePosts_ex.get(i).getPost_id()+" count:
			// "+post_likeRepository.findPost_like_num(freePosts_ex.get(i).getPost_id()));
		}
		model.addAttribute("map_like", map);
	...
	public String searchPost2(Model model, @PathVariable("pg") int pg, @RequestParam("search_type") String type,
	...
	public String searchPost(Model model, @RequestParam("search_type") String type,
			@RequestParam("keyword") String keyword, @RequestParam("pg") int pg) {
	...
	public String createComment(Model model, @PathVariable("id") int id, final HttpSession session,
			HttpServletRequest request, HttpServletResponse response, Comment comment) throws IOException {
	...
	public String createComment2(Model model, @PathVariable("id") int id, final HttpSession session,
			HttpServletRequest request, HttpServletResponse response, Comment comment) throws IOException {
	...
	public String createReply(Model model, @PathVariable("id") int id, @PathVariable("comment_id") int comment_id,
